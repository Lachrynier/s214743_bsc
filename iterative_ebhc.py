...
### Reconstructions
    ...
    # cap = None
    cap = b.max()
    b_noisy = skimage.util.random_noise(b.as_array(), mode='gaussian',clip=False, mean=0, var=(1/(1e2*I))**2)
    ...
    plt.scatter(A.direct(image).as_array().flatten()/factor, b.as_array().flatten(), alpha=0.2, color='black', label='Observed',s=3)
